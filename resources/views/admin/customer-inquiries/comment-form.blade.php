<form method="post" name="comment-form" id="comment-form"
    action="{{ route('admin.customer-inquiries.store-comment') }}">
    @csrf
    <input type="hidden" name="customer_inquiry_id" id="customer-inquiry_id" value="{{ @$customerInquiry->id }}">
    <div class="row">
        <div class="col-lg-12">
