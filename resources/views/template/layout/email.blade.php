...
<head>
  ...
  <style type="text/css">
    ...
    #footer-content {margin-left: 10px; padding-left: 10px}
...
<body style="margin: 0; padding: 0;">
    ...
    <div id="email-outer-wrapper">
        <div id="email-header">
            <img src="{{asset("assets/front/img/demos/auto-services/al_shamal_food_logo.png")}}" alt="Al Shamal Food Factory" style="max-width:125px;">
        </div>
        ...
        <div id="email-footer">
            This email was generated by the system.
        </div>
    </div>
</body>
</html>
