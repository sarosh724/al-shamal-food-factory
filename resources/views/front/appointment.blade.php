...
<div role="main" class="main">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								...
								<h1 class="text-dark"> <strong>Appointment</strong></h1>
				...
				<div class="container my-5 pt-4 pb-5">
					<div class="row mb-3">
						<div class="col">
							<p class="text-3-5">Lorem Ipsum is simply dummy text of the printing and typesetting industrLorem Ipsum is simply dummy text of the printing and typesetting industrLorem Ipsum is simply dummy text of the printing and typesetting industr</p>
							<p>Lorem Ipsum is simply dummy text of the printing and typesetting industrLorem Ipsum is simply dummy text of the printing and typesetting industrLorem Ipsum is simply dummy text of the printing and typesetting industrLorem Ipsum is simply dummy text of the printing and typesetting industr</p>
						</div>
					</div>
					<div class="row">
						<div class="col">
							<form class=" custom-form-style-1"  method="POST">
                                ...
                                <div class="contact-form-error alert alert-danger d-none1 mt-4">
                                ...
                                <div class="row pb-2 mb-4">
                                	<div class="col">
                                		<div class="alert alert-warning custom-alert-bg-color-1">
                                			<p class="text-2 mb-0"><i class="fas fa-info-circle me-1"></i> Please note that the date and time you requested may not be available. We will contact you to confirm your actual appointment details.</p>
                                		</div>
                                	</div>
                                </div>
                                <div class="row">
