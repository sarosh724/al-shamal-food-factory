...
<div role="main" class="main">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                    ...
                    <span class="sub-title text-dark">{{ $appointmentBreadcrumb->subtitle_english }}</span>
                </div>
    ...
    <div class="container my-5 pt-4 pb-5">
        <div class="row mb-3">
            <div class="col">
                <p class="text-3-5">{!! $appointment->description_english !!}</p>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <form class="custom-form-style-1" name="appointment-form" id="appointment-form" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="form-group col">
                            <textarea maxlength="5000" data-msg-required="Please enter your reason." rows="10" class="form-control"
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <input type="date" value="" data-msg-required="Please select a date."
                                        maxlength="100" class="form-control" name="first_date"
                                        id="first_date" required placeholder="Date">
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="time" value="" data-msg-required="Please select a time."
                                        maxlength="100" class="form-control" name="first_time"
                                        id="first_time" required placeholder="Time">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <input type="date" value="" data-msg-required="Please select a date."
                                        maxlength="100" class="form-control" name="second_date"
                                        id="second_date" required placeholder="Date">
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="time" value="" data-msg-required="Please select a time."
                                        maxlength="100" class="form-control" name="second_time"
                                        id="second_time" required placeholder="Time">
                                </div>
                            </div>
                        </div>
                    </div>
